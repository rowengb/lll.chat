  ...
  saveStreamedMessage: protectedProcedure
    .input(z.object({ 
      ...
      groundingSources: z.array(z.object({
        ...
        unfurledTitle: z.string().optional(),
        unfurledDescription: z.string().optional(),
        unfurledImage: z.string().optional(),
        unfurledFavicon: z.string().optional(),
        unfurledSiteName: z.string().optional(),
        unfurledFinalUrl: z.string().optional(),
        unfurledAuthor: z.string().optional(),
        unfurledPublishedDate: z.string().optional(),
        unfurledAt: z.number().optional(),
      })).optional(),
