...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen bg-gradient-to-br from-black via-gray-950/80 to-black text-white overflow-hidden">
        {/* Background Effects */}
        ...
        <div className="h-full overflow-y-auto overflow-x-hidden">
          {/* Header - Fixed at top */}
          <header className="relative z-10 px-4 sm:px-6 py-4 sm:py-6 flex-shrink-0">
            <nav className="max-w-6xl mx-auto flex items-center justify-between">
              <div className="flex items-center space-x-2 sm:space-x-3">
                <span className="text-2xl sm:text-3xl text-white font-[500]">
                  <span className="font-[650]">lll</span>.chat
              </span>
                <div className="hidden sm:block px-2.5 py-1 text-xs bg-white/[0.06] border border-white/[0.08] rounded-md text-white/70 font-[450]">
                Open Source
              </div>
            </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                <Button 
                  variant="ghost" 
                  className="hidden sm:flex text-white/60 hover:text-white/80 hover:bg-white/[0.04] border-0 text-sm font-[450] px-4 py-2 h-auto"
