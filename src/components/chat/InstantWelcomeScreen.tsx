...
interface InstantWelcomeScreenProps {
  // Layout props
...
export const InstantWelcomeScreen: React.FC<InstantWelcomeScreenProps> = ({
  sidebarCollapsed,
  sidebarWidth,
  onToggleSidebar,
  onOpenSearch,
  ...
  // Memoized example cards for performance
          ...
          <div className={`${sharedGridClasses} min-h-full flex items-center justify-center pb-24 sm:pb-32`}>
            ...
            <div className="w-full">
              <div className={sharedLayoutClasses}>
                {/* Welcome elements - Static content renders immediately */}
                <div className={`text-center transition-all duration-300 ${showWelcomeElements ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
                  {/* Welcome Header - Static, instant render */}
                  ...
                  {/* Example Prompts - Static content, instant render */}
                  <div className="mb-6 sm:mb-8">
                    {/* Desktop: Grid layout */}
